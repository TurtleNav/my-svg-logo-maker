...
describe('Shape', () => {
  test("render method should raise an error when not properly implemented in a child class", () => {
    ...
    /*
        The three property setting tests below check that the Shape base class
        does indeed set these properties. This behavior is paramount (hence
        why it is being tested) because we cannot render our image without them
    */
...
// Test that the Circle class's render method works on a random combination
// of color, text, and text color
describe('Circle', () => {
...
// Test that the Square class's render method works on a random combination
// of color, text, and text color
describe('Square', () => {
...
// Test that the Triangle class's render method works on a random combination
// of color, text, and text color. Additionally, we test with a hex color code.
describe('Triangle', () => {
